  ...
  getHeroActionPreflop = async () => {
    ...
    if (heroCards.length == 2) {
      if (origHeroAction !== this.heroPreflopAction) {
        ...
        if (this.heroPreflopAction === 'Fold' && $(`input#autoFold_${table_id}`).is(':checked')) {
        ...
        if (this.url === 'wss://gs1.wssdata1.com:4703/ws/game' && msg?.['payload'].t === 100 && msg['payload']?.p[0]) {
          ...
          <div class="hud hud-main" id="hud_${table_id}">
            ...
            <div class="hud hud-footer" id="hud_stats_footer_${table_id}">
              <label for="showFolded" class="hud hud-footer-options">
                <input type="checkbox" id="showFolded_${table_id}"/>
                Show Folded
              </label>
              <label for="autoFold" class="hud hud-footer-options">
                <input type="checkbox" id="autoFold_${table_id}"/>
              Auto-Fold Bad Hands Preflop
                </label>
                <div class="hud hud-footer-options" id="hud_opacity_${table_id}"/>
            </div>
          </div>`
