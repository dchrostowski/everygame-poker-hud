      ...
      case 'TableHandMuckedCards': {
        ...
        if (hand) {
          ...
          if(OW.HERO_NAME === 'cornbl4ster') {
            $(`div#hud_muck_${table_id}`).html(`<span class="hud-muck-advice">${playerName} mucked <span class="unicode-cards">${muckedUnicodeCards.join('')}</span> with [${hand.board}] on the board.</span>`)
          }
